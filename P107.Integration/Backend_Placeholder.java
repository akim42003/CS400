...
public class Backend_Placeholder implements BackendInterface {
    ...
    public void addRecord(GameRecord record) {
      tree.insert(new GameRecord("ne0nVandal", GameRecord.Continent.NORTH_AMERICA, 49723, 78, 177, "902:36:58"));
    } 
    
    // when this method is called, an extra record is added to this backend
    @Override
    public void readData(String filename) throws IOException {
      tree.insert(new GameRecord("voidR1fter", GameRecord.Continent.ANTARCTICA, 50883, 77, 239, "034:38:52"));
    }
    ...
    // filters are being completely ignored here, and the ten least damage taken records 

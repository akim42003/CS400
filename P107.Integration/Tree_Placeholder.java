...
public class Tree_Placeholder implements IterableSortedCollection<GameRecord> {
    ...
    private List<GameRecord> records = Arrays.asList(
        new GameRecord("speedRoyalty", GameRecord.Continent.EUROPE, 47403,80,53, "640:09:00"),
        new GameRecord("xXxgamer47xXx", GameRecord.Continent.ASIA, 48563,79,115,"956:48:46"),
        new GameRecord("v0idt3mp0", GameRecord.Continent.AFRICA, 42023,181,1, "634:06:42"));

...
public interface FrontendInterface {
     ...
     * to handle correctly.
     * 
     * submit NAME CONTINENT SCORE DAMAGE_TAKEN DAMAGE_GIVEN COMPLETION_TIME
     ...
     *           least damage: argument displays results returned from the

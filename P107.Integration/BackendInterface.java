...
public interface BackendInterface {
    ...
    /** Add and stores the specified record to the tree. This will be used to store these records in order within your
     ...
     * The records should be ordered by the record's score, and fall within
     * the specified range of score values.  This score range will
     ...
     * score to include in the returned list.
     *
     * @param low is the minimum score of records in the returned list
     * @param high is the maximum score of records in the returned list
     ...
     * score, and should only include records that fall within the specified
     * range of score values that was established by the most recent call
     * to getRange.  If getRange has not previously been called, then no low
     * or high score bound should be used.  The filter set by this method
     ...
     *     are within any previously set score range, or an empty list 
     ...
     * ten lowest damage taken records that both fall within any attribute range specified
     ...
     *
     * @return List of ten lowest damage taken record names
     */

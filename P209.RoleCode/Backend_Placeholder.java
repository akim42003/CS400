...
public class Backend_Placeholder implements BackendInterface {
	...
	// private method to hardcode locations instead of using nonexistent getAllNodes
	private List<String> getAllLocations() {
		List<String> allLocations = new ArrayList<>();
		allLocations.add("Union South");
		allLocations.add("Computer Sciences and Statistics");
		allLocations.add("Weeks Hall for Geological Sciences");
		return allLocations;
	}
	...
	public List<String> getFurthestFromList(String start) throws NoSuchElementException {
		List<String> all = getAllLocations();
